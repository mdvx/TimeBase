...
import static deltix.util.vsocket.util.TestServerSocketFactory.LatencyServerSocket.NUM_MESSAGES;
import static deltix.util.vsocket.util.TestServerSocketFactory.LatencyServerSocket.NUM_PER_BURST;
