...
public class Test_DynamicAPI {
    ...
    private void         testFixedBar (CodecFactory factory) {
        ...
        deltix.timebase.api.messages.BarMessage bar = mkBar (timestamp);
        ...
        
        {
            ...
            {
                deltix.timebase.api.messages.BarMessage msg2 = (deltix.timebase.api.messages.BarMessage) cursor.getMessage ();
...
//                    else 
    ...
    public void         testBoundPoly () {
        long                        timestamp = System.currentTimeMillis ();
        deltix.timebase.api.messages.BarMessage bar = mkBar (timestamp);
        deltix.timebase.api.messages.TradeMessage trade = mkTrade (timestamp + 1);
        ...
        
        {
            ...
            {
                deltix.timebase.api.messages.TradeMessage msg2 = (deltix.timebase.api.messages.TradeMessage) cursor.getMessage ();
    ...
    private deltix.timebase.api.messages.BarMessage mkBar (long timestamp) {
    ...
    private deltix.timebase.api.messages.TradeMessage mkTrade (long timestamp) {
