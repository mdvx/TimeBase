...
import deltix.qsrv.util.json.JSONRawMessageParser;
...
import static deltix.qsrv.hf.pub.Test_RecordCodecsArrays.*;
...
public class Test_JSON {
    ...
    public void verify() throws Exception {
        ...
        Test_RecordCodecsArrays.Execution msg = new Execution();
        msg.setSymbol("ZZZ");
