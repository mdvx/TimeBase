...
//    }
            ...
            throws IOException, ParseException
    {
        ...
        final deltix.timebase.api.messages.BarMessage bar = new deltix.timebase.api.messages.BarMessage();
        while (csv.nextLine()) {
            int idx = 0;
    ...
    private static void compare(String etalonFile, InstrumentMessage[] actual) throws IOException, ParseException {
        final List<deltix.timebase.api.messages.BarMessage> messages = new ArrayList<deltix.timebase.api.messages.BarMessage>();
        final TickLoader loader = new TickLoader<InstrumentMessage>() {
            ...
            public void send(InstrumentMessage msg) {
                messages.add((deltix.timebase.api.messages.BarMessage) msg.clone());
            }
        ...
        final deltix.timebase.api.messages.BarMessage[] expected = messages.toArray(new deltix.timebase.api.messages.BarMessage[messages.size()]);
        sort(expected);
        sort(actual);
