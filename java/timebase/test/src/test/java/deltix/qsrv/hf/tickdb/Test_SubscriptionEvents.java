...
import deltix.qsrv.hf.tickdb.pub.query.SubscriptionManager;
...
public class Test_SubscriptionEvents extends TDBRunnerBase {
    ...
    public void             testTypes (DXTickDB db) throws Exception {
        ...
        try (TickCursor c = stream.select(0, so, new String[]{}, new IdentityKey[]{})) {
            ...
            c.addTypes(deltix.timebase.api.messages.TradeMessage.class.getName());

            listener.testAdded(counter++, new ConstantIdentityKey("AAPL"));
            listener.testAdded(counter++, deltix.timebase.api.messages.TradeMessage.class.getName());
        }
    ...
    public void             testTypes1 (DXTickDB db) throws Exception {
        ...
        try (TickLoader loader = stream.createLoader ()) {
            ...
            try (TickCursor c = stream.select(0, so,
                    new String[] { deltix.timebase.api.messages.TradeMessage.class.getName()},
...
//            counter++;
            ...
            c1.addTypes(deltix.timebase.api.messages.TradeMessage.class.getName());
            listener.testRemoved(counter++, (String[]) null);
            listener.testAdded(counter++, deltix.timebase.api.messages.TradeMessage.class.getName());
            test((SubscriptionManager)c1, deltix.timebase.api.messages.TradeMessage.class.getName());

            c1.setTypes(deltix.timebase.api.messages.BestBidOfferMessage.class.getName());
            listener.testRemoved(counter++, deltix.timebase.api.messages.TradeMessage.class.getName());
            listener.testAdded(counter++, deltix.timebase.api.messages.BestBidOfferMessage.class.getName());

            c1.removeTypes(deltix.timebase.api.messages.BestBidOfferMessage.class.getName());
            listener.testRemoved(counter++, deltix.timebase.api.messages.BestBidOfferMessage.class.getName());
            ...
            c1.add(new IdentityKey[] {key}, new String[] {deltix.timebase.api.messages.BarMessage.class.getName()} );
            listener.testAdded(counter++, key);
            listener.testAdded(counter++, deltix.timebase.api.messages.BarMessage.class.getName());
    ...
    public void             run2 (DXTickDB db) throws Exception {
        ...
        try {
            ...
            c1.setTypes(deltix.timebase.api.messages.TradeMessage.CLASS_NAME);
            c1.removeTypes(deltix.timebase.api.messages.TradeMessage.CLASS_NAME);
            c1.subscribeToAllTypes();
