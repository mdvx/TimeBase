...
public class Test_OpenTwoReadOnly {
    ...
    private deltix.timebase.api.messages.TradeMessage trade = new deltix.timebase.api.messages.TradeMessage();
    ...
    public void     openTwo () throws InterruptedException {
        ...
        deltix.timebase.api.messages.TradeMessage msg1 = (deltix.timebase.api.messages.TradeMessage) c1.getMessage ();
        deltix.timebase.api.messages.TradeMessage msg2 = (deltix.timebase.api.messages.TradeMessage) c2.getMessage ();
