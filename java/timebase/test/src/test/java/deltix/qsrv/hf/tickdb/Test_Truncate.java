...
//                new SelectionOptions(false, false, false, SelectionOptions.ABORT_CURSOR));
        ...
        deltix.timebase.api.messages.BarMessage msg;
        
        for (int ii = 0; ii < 500; ii++)
            cur1.next ();        
        
        //  Save bar number 500 to later write it back, thus truncating the stream
        msg = (deltix.timebase.api.messages.BarMessage) cur1.getMessage ().clone();
        ...
        throws InterruptedException
    {
        ...
        try {
            ...
            msg = (deltix.timebase.api.messages.BarMessage) cur.getMessage ().clone();
        ...
        public void     run () {
            ...
            try {
                for (int i = 0; i < NUMBER_OF_MESSAGES && cur.next(); i++) {
                    deltix.timebase.api.messages.BarMessage msg = (deltix.timebase.api.messages.BarMessage) cur.getMessage();
                    // add 1 year
        ...
        throws InterruptedException, ParseException
    {
        ...
        try {
            ...
            deltix.timebase.api.messages.BarMessage msg = (deltix.timebase.api.messages.BarMessage) cur.getMessage ().clone();
            TickLoader          loader = stream.createLoader ();
            loader.send (msg);
            loader.close ();
