...
import deltix.qsrv.hf.tickdb.http.stream.ListEntitiesRequest;
...
import deltix.util.codec.Base64EncoderEx;
...
public class Test_HttpSecured {
    ...
    public void                 testHTTPSelect() throws IOException, JAXBException {
        ...
        sr.types = new String[] { "deltix.timebase.api.messages.BarMessage" };
    ...
    public void testSelectAsStruct() throws IOException, JAXBException {
        ...
        rt.name = "deltix.timebase.api.messages.BarMessage";
