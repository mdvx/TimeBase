...
import deltix.qsrv.hf.tickdb.schema.Test_SchemaConverter;
...
import deltix.timebase.api.messages.trade.OrderType;
import deltix.timebase.api.messages.trade.TimeInForce;
import deltix.timebase.messages.schema.SchemaChangeMessage;
import deltix.timebase.messages.schema.SchemaDescriptorChangeAction;
import deltix.timebase.messages.schema.SchemaDescriptorChangeActionInfo;
import deltix.timebase.messages.schema.SchemaDescriptorChangeType;
...
public class Test_TDBServer {
    ...
    public void     testFlush() throws IOException, InterruptedException {
        ...
        try {
            Random rnd = new Random();
            BarMessage message = new deltix.timebase.api.messages.BarMessage();
            message.setSymbol("ES1");
...
//    }
    ...
    public void testSelectAPI() {
        ...
        TickCursor cursor1 = db.select(0,
            ...
            new String[] {deltix.timebase.api.messages.BarMessage.class.getName()}, new CharSequence[] { "AAPL"}, stream);

        TickCursor cursor2 = db.createCursor(new SelectionOptions(), stream);
        cursor2.setTypes(deltix.timebase.api.messages.BarMessage.class.getName());
    ...
    public void testSimpleSelect() {
        ...
        TickCursor cursor1 = db.select(Long.MIN_VALUE,
            new SelectionOptions(),
            new String[] {deltix.timebase.api.messages.BarMessage.class.getName()},
            keys,
            stream);
    ...
    public  void testLoad() throws InterruptedException {
        try (DXTickDB db = TickDBFactory.createFromUrl("dxtick://localhost:8098")) {
            db.open(false);
            ...
            stream = db.createStream("test",
                        StreamOptions.polymorphic(StreamScope.DURABLE, "test", null, 0, bbo, trade, l2));
...
//        };
    ...
    public void testMessages() throws Introspector.IntrospectionException {
        ...
        changeAction.setChangeTypes(SchemaDescriptorChangeType.ALTER);
