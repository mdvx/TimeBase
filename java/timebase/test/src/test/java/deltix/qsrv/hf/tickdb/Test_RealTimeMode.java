...
//    }
    ...
    public void testLive() throws InterruptedException {
        ...
        populateStream(historicStream, new TDBRunner.BarsGenerator(new GregorianCalendar(2010, 1, 1), (int) deltix.timebase.api.messages.BarMessage.BAR_MINUTE, 100, "MSFT", "AAPL"));
        ...
        Thread liveStreamProducer = new Thread() {
            @Override
            public void run() {
                populateStream(liveStream, new TDBRunner.BarsGenerator(null, (int) deltix.timebase.api.messages.BarMessage.BAR_MINUTE, 100, "Q", "W") {
                    int counter = 0;
                    @Override
                    public boolean next() {
                        counter++;
        ...
        Thread producer = new Thread() {
            ...
            public void run() {
                TDBRunner.BarsGenerator gn =
                    new TDBRunner.BarsGenerator(new GregorianCalendar(), (int) deltix.timebase.api.messages.BarMessage.BAR_MINUTE, 100, "QQQQ", "WWWW");
...
//                        "WWWW".equals(message.getSymbol().toString());
    ...
    public void testLive2() throws InterruptedException {
        ...
        Thread producer = new Thread() {
            ...
            public void run() {
                TDBRunner.BarsGenerator gn =
                    new TDBRunner.BarsGenerator(null, (int) deltix.timebase.api.messages.BarMessage.BAR_MINUTE, -1,
                            "QQQQ", "WWWW", "DDDD");
...
//        } while (cursor.next() && count < 10);
    ...
    public void testLiveHist() throws InterruptedException {
        ...
        Thread producer = new Thread() {
            ...
            public void run() {
                TDBRunner.BarsGenerator gn =
                    new TDBRunner.BarsGenerator(null, (int) deltix.timebase.api.messages.BarMessage.BAR_MINUTE, 100, "QQQQ", "WWWW");
