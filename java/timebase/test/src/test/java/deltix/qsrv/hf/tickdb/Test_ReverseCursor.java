...
*/
    ...
    public void testMsgTypeFiltering() throws IOException, InterruptedException {
        ...
        select(time, stream, new String[] {deltix.timebase.api.messages.BestBidOfferMessage.class.getName()}, ids, "bbo_2s.txt");
    }
...
//                    cursor.setFilter(filter);
                    cursor.setTypes(deltix.timebase.api.messages.BestBidOfferMessage.class.getName());
                    done = true;
                }
            }
        };
