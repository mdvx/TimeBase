...
public class Test_RecordCodecs4 extends Test_RecordCodecsBase {
    ...
    public void testEarlyBinding() {
        ...
        {
            final NonStaticFieldLayout layout = new NonStaticFieldLayout(new deltix.qsrv.hf.pub.md.NonStaticDataField("mBoolean", null, new BooleanDataType(false)));
            layout.bind(MsgClassAllPublic.class);
        }
        try {
            final NonStaticFieldLayout layout = new NonStaticFieldLayout(new deltix.qsrv.hf.pub.md.NonStaticDataField("mBoolean", null, new BooleanDataType(true)));
            layout.bind(MsgClassAllPublic.class);
