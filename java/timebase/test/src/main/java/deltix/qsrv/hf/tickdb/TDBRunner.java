...
import deltix.qsrv.hf.tickdb.comm.client.SecuredDbClient;
...
import deltix.qsrv.hf.tickdb.pub.DirectTickDBClient;
...
import deltix.qsrv.hf.tickdb.pub.TimeBaseServerRegistry;
import deltix.qsrv.hf.tickdb.pub.TopicDBFactory;
import deltix.qsrv.hf.tickdb.test.EmbeddedServer;
...
//            }
    ...
    public static class BBOGenerator extends BaseGenerator<InstrumentMessage>
    {
        ...
        public boolean next() {
            ...
            deltix.timebase.api.messages.BestBidOfferMessage message = new deltix.timebase.api.messages.BestBidOfferMessage();
