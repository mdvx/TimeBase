...
public class TimeCodec {
    ...
    private static long          readTime (byte head, int scale, MemoryDataInput in) {
        ...
        switch (scale) {
            ...
            default:
                throw new deltix.util.io.UncheckedIOException ("Illegal time scale in byte: " + head);
        }
    }
        ...
        switch (scale) {
            ...
            case TIME_SCALE_SPECIAL:
                ...
                switch (ret) {
                    ...
                    default:
                        throw new deltix.util.io.UncheckedIOException ("Illegal value in byte: " + head);
                }
...
//                    default:    throw new deltix.util.io.UncheckedIOException ("Illegal value in byte: " + head);
//                }
//
//            default:
//                throw new deltix.util.io.UncheckedIOException ("Illegal time scale in byte: " + head);
