...
import deltix.qsrv.hf.tickdb.comm.ProtocolViolationException;
import deltix.qsrv.hf.tickdb.comm.TDBProtocol;
import deltix.qsrv.hf.tickdb.comm.TypeSet;
import deltix.qsrv.hf.tickdb.impl.IdleStrategyProvider;
import deltix.qsrv.hf.tickdb.impl.InternalByteArrayInputStream;
...
import deltix.qsrv.hf.tickdb.pub.query.SymbolAndTypeSubscriptionControllerClient;
...
import deltix.util.io.aeron.AeronPublicationDSAdapter;
import deltix.util.io.aeron.PublicationClosedException;
import deltix.util.lang.Util;
import deltix.util.memory.DisposableResourceTracker;
...
import static deltix.qsrv.hf.tickdb.comm.client.TickCursorClient.ReceiverState;
...
//                state = ReceiverState.ACCUMULATING;
    ...
    private NextResult queryStream() {
        ...
        while (true) {
            ...
            if (code < 0) {
                throw new deltix.util.io.UncheckedIOException(new EOFException());
            }
