...
import deltix.qsrv.hf.spi.conn.ReconnectableImpl;
import deltix.qsrv.hf.tickdb.comm.CompileExceptionResolver;
import deltix.qsrv.hf.tickdb.comm.NotConfiguredException;
import deltix.qsrv.hf.tickdb.comm.TDBProtocol;
import deltix.qsrv.hf.tickdb.comm.TopicProtocol;
import deltix.qsrv.hf.tickdb.comm.UnknownStreamException;
import deltix.qsrv.hf.tickdb.comm.UserPrincipal;
import deltix.qsrv.hf.tickdb.impl.topic.AddTopicPublisherRequest;
import deltix.qsrv.hf.tickdb.impl.topic.AddTopicPublisherResponse;
import deltix.qsrv.hf.tickdb.impl.topic.AddTopicSubscriberRequest;
import deltix.qsrv.hf.tickdb.impl.topic.AddTopicSubscriberResponse;
import deltix.qsrv.hf.tickdb.impl.topic.CreateCustomTopicRequest;
import deltix.qsrv.hf.tickdb.impl.topic.CreateMulticastTopicRequest;
import deltix.qsrv.hf.tickdb.impl.topic.CreateTopicRequest;
import deltix.qsrv.hf.tickdb.impl.topic.DeleteTopicRequest;
import deltix.qsrv.hf.tickdb.impl.topic.GetTopicInstrumentMappingRequest;
import deltix.qsrv.hf.tickdb.impl.topic.GetTopicInstrumentMappingResponse;
import deltix.qsrv.hf.tickdb.impl.topic.GetTopicMetadataRequest;
import deltix.qsrv.hf.tickdb.impl.topic.GetTopicMetadataResponse;
import deltix.qsrv.hf.tickdb.impl.topic.GetTopicTemporaryInstrumentMappingRequest;
import deltix.qsrv.hf.tickdb.impl.topic.GetTopicTemporaryInstrumentMappingResponse;
import deltix.qsrv.hf.tickdb.impl.topic.ListTopicsResponse;
import deltix.qsrv.hf.tickdb.impl.topic.TopicClientChannel;
import deltix.qsrv.hf.tickdb.impl.topic.TopicTransferType;
import deltix.qsrv.hf.tickdb.lang.pub.Token;
import deltix.qsrv.hf.tickdb.lang.pub.TokenType;
import deltix.qsrv.hf.tickdb.pub.DBStateListener;
import deltix.qsrv.hf.tickdb.pub.DBStateNotifier;
...
import deltix.qsrv.hf.tickdb.pub.topic.exception.TopicApiException;
...
import deltix.thread.affinity.PinnedThreadFactoryWrapper;
        ...
        try {
            ...
            if (result == TDBProtocol.RESP_OK) {
                ...
                if (!readOnly && accept == TDBProtocol.READ_ONLY)
                    throw new deltix.util.io.UncheckedIOException ("Server is read-only");
...
//                    throw new IncompatibleClientVersionException (serverProtocolVersion, serverVersion);
            ...
            throw new deltix.util.io.UncheckedIOException ("Cannot open timebase [" + TDBProtocol.getProtocol(enableSSL) + "://" + host + ":" + port + "]" , iox);
        } finally {
            Util.close (ds);
        }
