...
import deltix.qsrv.hf.tickdb.comm.client.UserDBClient;
...
public class TickDBFactory {
    ...
    public static DXTickDB       create (File ... paths) {
        ...
        //return (new deltix.qsrv.hf.tickdb.impl.TickDBImpl (paths));
    }
    ...
    public static DXTickDB       create (DataCacheOptions options, File ... paths) {
        ...
        //return (new deltix.qsrv.hf.tickdb.impl.TickDBImpl (options, paths));
    }
