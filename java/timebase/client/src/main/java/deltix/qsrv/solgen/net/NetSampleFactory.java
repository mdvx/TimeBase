...
import deltix.qsrv.solgen.net.samples.ProgramSample;
import deltix.qsrv.solgen.net.samples.ReadStreamSample;
import deltix.qsrv.solgen.net.samples.WriteStreamSample;
