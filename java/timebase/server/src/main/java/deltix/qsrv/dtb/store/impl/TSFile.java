...
import deltix.qsrv.dtb.store.pub.AbstractSingleEntityFilter;
import deltix.qsrv.dtb.store.pub.EntityFilter;
import deltix.qsrv.dtb.store.pub.ListEntityFilter;
import deltix.qsrv.dtb.store.pub.SingleEntityFilter;
...
import static deltix.qsrv.dtb.store.impl.TSFState.*;
