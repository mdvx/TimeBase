package deltix.qsrv.hf.tickdb.impl.streamqueue.queue.binaryheap;
 ...
 */
public final class PriorityQueueGeneralizedWithDataNoHeadRemoval<T> {
    /**
    ...
    private boolean headHole = false;

    public PriorityQueueGeneralizedWithDataNoHeadRemoval(int capacity, boolean ascending) {
        init (capacity);
    ...
    public void putBack(T obj, long objKey) {
        if (!headHole) {
