 ...
 */
public class NoMoveObjectFixedPriorityQueue {
    ...
    public <T extends TimeStampedMessage> NoMoveObjectFixedPriorityQueue(Collection<MessageSource<T>> sources) {
