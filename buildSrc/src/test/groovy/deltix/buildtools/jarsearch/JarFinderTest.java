...
public class JarFinderTest {
    ...
    @Test
    public void test1() {
        String value = jarFinder.getJarNameByClassName("deltix.qsrv.comm.cat.TomcatCmd");
    ...
    @Test
    public void test2() {
        String value = jarFinder.getJarNameByClassName("deltix.installer.admin.top.QSAdminMain");
        Assert.assertTrue(value.startsWith("deltix-quantserver-gui-"));
        Assert.assertTrue(value.endsWith(".jar"));
    }
}