...
class CursorTest(servertest.TestWithStreams):
    ...
    # TODO:
    #  Seems like setTimeForNewSubscriptions() not works at all
    #
    # def test_SetTimeForNewSubscription(self):
    #     barStream = self.db.getStream(self.streamKeys[0])
    #     cursor = self.db.select(0, [barStream], dxapi.SelectionOptions(), None, None)
    #
    ...
    #     messages = self.read(cursor, 10)
    #     self.checkSymbols(messages, self.entities.keys())
